...
def aggiungiDelta():
    ...
    for track in termTracksList:
        ...
        print("stampa punto:.........", punto)
        print("prova_FK", track.LonWGS84, track.LatWGS84)
        
        P1 = Point(float(track.LonWGS84), float(track.LatWGS84))
        print(P1.x)
        print(P1.y)
        P1.transform(4326, 32632)
        print("AGGIUNGI 2: ", P1.x)
        print("AGGIUNGI 2: ", P1.y)
        
        
        punto.transform(4326, 32632)
        print("prova_AAA", punto.x, punto.y)
...
##            break
        ...
        LonWGS84, LatWGS84,\
        Velocita,Direzione,Qualita,Pannello,Distanza,Strada \
